...
function TechnicianCard({ technician, onBook }) {
  return (
    <article className="overflow-hidden rounded-[24px] border border-[#e7ecf1] bg-white shadow-[0_16px_40px_-32px_rgba(15,23,42,0.15)] transition hover:-translate-y-1">
